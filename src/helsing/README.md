...
- `CheckStakeVerificationBlockedSkeleton` composes revised spec `StakeVerify` steps 1-11 without an accepting path: it runs the step-1-through-7 output checks, then the proof-verification blocker.
